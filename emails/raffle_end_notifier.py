...
def body_renderer(user):
    ...
    Just a reminder, you can win a $50 gift card, Kindle, or potentially a Nexus 7 by reviewing courses and profs on Flow! You'll need 300 points to qualify, and each point is another chance to win.
